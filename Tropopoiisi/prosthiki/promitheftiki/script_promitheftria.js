    ...
    function changeButtons(){
        ...
        function show(x){
            ...
            alert(num);
                        if(proceed) {
                            ...
                            $.post('prosthiki/promitheftiki/script_promitheftria.php', post_data, function(response){
                                alert(response.Name);
        ...
        function addCompany(i){
            ...
            if (choiceCount < 10 && intTextBox < 20) {
                ...
                newTr.innerHTML ='<td class="t0"><strong>'+intTextBox+'</strong></td><td class="t1">'+name+'</td><td><input type="image" src="../images/Deep_Edit.png" onclick="show(this);" data-toggle="modal" data-target="#suplCompanyModal"></td><td><input type="image" src="../images/delete-icon.png" onclick= "removeCompanyID('+intTextBox+');"></td>';
